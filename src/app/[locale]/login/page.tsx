          ...
          <form onSubmit={handleAuth} className="space-y-6">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#121212] px-2 text-neutral-500 font-bold tracking-widest">
                  {t("or")}
                </span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-2xl font-medium transition-all active:scale-[0.98] disabled:opacity-50 disabled:scale-100 flex items-center justify-center gap-3"
            >
