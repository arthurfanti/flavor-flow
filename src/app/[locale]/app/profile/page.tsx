  ...
  return (
    <div className="max-w-2xl mx-auto p-6 pb-24 animate-fade-in">
      <header className="mb-12">
        <span className="text-brand-primary font-sans font-bold uppercase tracking-[0.3em] text-[10px] block mb-2">
          {t("subtitle")}
        </span>
      ...
      <div className="p-8 md:p-10 border border-white/5 rounded-3xl bg-gradient-to-br from-[#1A1A1A] to-[#202020] shadow-2xl">
        <form onSubmit={handleSave} className="space-y-10">
          <div className="space-y-4">
            <label
              htmlFor="displayName"
              className="flex items-center gap-2 text-sm font-bold text-neutral-300 uppercase tracking-widest"
            >
