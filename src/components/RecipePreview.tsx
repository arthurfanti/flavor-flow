          ...
          <div className="grid lg:grid-cols-[1fr_1.8fr] gap-16">
            <div className="space-y-8">
              <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                <h3 className="text-[11px] font-sans font-bold text-neutral-500 uppercase tracking-[0.2em]">
                  {t("ingredients")}
                </h3>
                <span className="text-[10px] bg-white/5 text-neutral-400 px-2 py-0.5 rounded-full">
              ...
              <ul className="space-y-5">
                {recipe.ingredients.map((ingredient, index) => (
                  <li
                    key={index}
                    className="flex items-start gap-4 text-[16px] leading-relaxed text-neutral-300 group"
                  >
            ...
            <div className="space-y-8">
              <h3 className="text-[11px] font-sans font-bold text-neutral-500 uppercase tracking-[0.2em] border-b border-white/5 pb-4">
                {t("preparation")}
              </h3>
