...
export default function MainLayout({ children }: MainLayoutProps) {
  return (
    <div className="min-h-screen w-full relative flex flex-col bg-[#fefcff] text-gray-900">
      <header className="w-full py-6 px-6 bg-white/90 backdrop-blur-xl border-b border-ui-border shadow-[0_1px_3px_rgba(0,0,0,0.02)] sticky top-0 z-50">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-gray-600 backdrop-blur-sm">
